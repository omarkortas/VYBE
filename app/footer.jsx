        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          ...
          <div>
            ...
            <div className="flex gap-6 mt-8">
              <a href="https://www.instagram.com/vybe._.official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="text-gray-600 hover:text-gray-900 transition">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600 font-light">
              <li><a href="/collectionstickers" className="hover:text-gray-900 transition">Stickers Premium</a></li>
              <li><a href="/collectionportecle" className="hover:text-gray-900 transition">Porte-clés Exclusifs</a></li>
              <li><a href="/creations" className="hover:text-gray-900 transition">Nouveautés</a></li>
              <li><a href="/creations" className="hover:text-gray-900 transition">Éditions Limitées</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600 font-light">
              <li><a href="/about" className="hover:text-gray-900 transition">Notre Histoire</a></li>
              <li><a href="/collections" className="hover:text-gray-900 transition">Savoir-faire</a></li>
